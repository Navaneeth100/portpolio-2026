export const PORTFOLIO_DATA = {
  name: "Navaneeth K P",
  title: "Full Stack Developer | MEARN | Django",
  email: "navaneethkp100@gmail.com",
  phone: "+91 8891123221",
  location: "Kozhikode, Kerala",
  bio: "Full Stack Developer with 2+ years of experience in React.js, MEARN Stack, and Django. Passionate about building scalable web applications, dashboards, and business solutions that deliver real-world impact.",
  ...
  social: [
    { name: "GitHub", url: "https://github.com/Navaneeth100", icon: "github" },
    { name: "LinkedIn", url: "https://www.linkedin.com/in/navaneeth-k-p-56342a283/", icon: "linkedin" },
    { name: "Whatsapp", url: "https://wa.me/qr/OZU73P2I2PB6H1", icon: "whatsapp" },
    { name: "Instagram", url: "https://www.instagram.com/n.vnthhh?igsh=MXFzc2xyYTh3ZDRuZQ==", icon: "instagram" },
    { name: "Email", url: "mailto:navaneethkp100@gmail.com", icon: "email" }
  ]
};
